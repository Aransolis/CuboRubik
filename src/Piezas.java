public class Piezas {
    ...
    public Central piezasCentral[];
    public Lateral piezaLateral[];
    public Esquina piezaEsquina[];

    public Piezas() {
        piezasCentral = new Central[6];
        for (int i = 0; i < piezasCentral.length; i++) {
            piezasCentral[i] = new Central();
        }
    ...
    public char quienCentral(char orient) {
        ...
        int i = 0; //PIEZAS
        int j = 0; //HORIZONTAL
        while (i < piezasCentral.length && !esta) {
            j = 0;
            while (j < piezasCentral[i].tupla.orien.length && !esta) {
                if (piezasCentral[i].tupla.orien[j] == orient) {
                    esta = true;
                    color = piezasCentral[i].tupla.color[j];
    ...
    public void iniciaPiezas() {
        piezasCentral[0].tupla.color[0] = 'B';
        piezasCentral[0].tupla.orien[0] = 'R';
        piezasCentral[1].tupla.color[0] = 'Y';
        piezasCentral[1].tupla.orien[0] = 'F';
        piezasCentral[2].tupla.color[0] = 'R';
        piezasCentral[2].tupla.orien[0] = 'U';
        piezasCentral[3].tupla.color[0] = 'G';
        piezasCentral[3].tupla.orien[0] = 'L';
        piezasCentral[4].tupla.color[0] = 'O';
        piezasCentral[4].tupla.orien[0] = 'D';
        piezasCentral[5].tupla.color[0] = 'W';
        piezasCentral[5].tupla.orien[0] = 'B';
                ...
                if (piezaLateral[i].tupla.orien[j] == cara) {
                    for (int k = 0; k < piezaLateral[i].tupla.orien.length; k++) {
                        if (piezaLateral[i].tupla.orien[k] != cara) {
                            char caraActual = piezaLateral[i].tupla.orien[k];
                            int caraNueva = 0;
                            while (caraActual != movsF[caraNueva])
                                caraNueva++;
                            if (signo == 0)
                                caraNueva++;
                            else
                            ...
                            if (caraNueva < 0)
                                ...
                                caraNueva = 0;
                            piezaLateral[i].tupla.orien[k] = movsF[caraNueva];
                        }
                    }
                }
            }
                    ...
                    for (int k = 0; k < piezaEsquina[i].tupla.orien.length; k++) {
                        if (piezaEsquina[i].tupla.orien[k] != cara) {
                            ...
                            if (caraNueva < 0)
                                ...
                                caraNueva = 0;
                            piezaEsquina[i].tupla.orien[k] = movsF[caraNueva];
                        }
                    }
                }
            }
